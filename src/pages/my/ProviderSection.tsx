 ...
 * `pending`·`reviewing`에서도 **프로그램 등록은 됩니다** — 그걸 적어두지 않으면 자격
 * 심사가 끝날 때까지 기다려야 하는 것으로 읽힙니다. (⑨, 2026-09-09) 게시는 자격 승인 뒤에
 * 자동으로 됩니다 — 「게시하기」를 눌러두면 승인 순간 열립니다.
 */
const APPROVAL_NOTICE: Record<string, { title: string; body?: string }> = {
  pending: {
    title: "자격 심사를 기다리고 있습니다.",
    body: "프로그램은 지금도 등록해 둘 수 있습니다. 「게시하기」를 눌러두면 자격 승인이 끝나는 순간 자동으로 게시됩니다. 승인 전에는 프로필에 「인증」 표시가 붙지 않습니다.",
  },
  reviewing: {
    title: "담당자가 자격 서류를 확인하고 있습니다.",
    body: "결과가 나오면 이 화면에 표시됩니다. 그동안에도 프로그램을 등록해 둘 수 있고, 승인되면 「게시하기」를 눌러둔 프로그램이 자동으로 열립니다.",
  },
  approved: {
    title: "심사를 통과한 전문가 계정입니다.",
    body: "프로그램은 「게시하기」를 누르는 순간 바로 공개됩니다. 운영자가 사후에 확인하고, 문제가 있으면 사유를 적어 내릴 수 있습니다.",
  },
};
