 ...
 * 미게시 상태 안내.
 *
 * **이 화면을 보는 사람이 소유자·관리자만은 아닙니다** (2026-09-08). 내려간
 * 프로그램은 **예약한 손님에게도** 보입니다 — 돈을 낸 사람이 무엇을 예약했는지
 * 볼 수 없으면 안 되기 때문입니다(서버 `getProgram`). 그래서 `hidden` 문구는
 * 양쪽이 함께 읽어도 말이 되게 씁니다: 새 예약이 닫혔다는 사실과, **이미 한
 * 예약은 그대로 유효하다**는 것을 함께 알립니다.
 */
